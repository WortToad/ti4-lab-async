...
- **User-supplied logo**: `public/brand/ti4-draft-command.png` is an unchanged copy. It is also used for the favicon, installed app, social metadata, notifications, and exported map branding.
